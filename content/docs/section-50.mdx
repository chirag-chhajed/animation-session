---
title: useSpring and useTransform
description: useSpring and useTransform
---

## useSpring

`useSpring` creates smooth, natural animations based on spring physics (like tension and bounce), often used to animate a value gradually.
...
`useTransform` takes an input value and maps it to a new output range — like turning scroll position into scale or opacity changes
